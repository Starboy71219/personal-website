    ...
    update() {
        ...
        if (ax != 0 || ay != 0) {
            ...
            if (landscapeOrientation) {
                this.directionX = this.directionX + ay/5000;
                this.directionY = this.directionY + ax/5000;
            } else {
                this.directionX = this.directionX - ax/5000;
        ...
        if (this.directionX > window.innerWidth/200) {
            this.directionX = window.innerWidth/200;
        }
        if (this.directionX < -window.innerWidth/200) {
            this.directionX = -window.innerWidth/200;
        }
        if (this.directionY > window.innerHeight/200) {
            this.directionY = window.innerHeight/200;
        }
        if (this.directionY < -window.innerHeight/200) {
            this.directionY = -window.innerHeight/200;
        }
...
function update() {
    ...
    context.fillText("Final Cut Pro", bx3 - bs / 2, by3 - bs / 2, r3);
    context.fillStyle = "#623";
    context.fillText("MATLAB", bx4 - bs / 2, by4 - bs / 2, r4);
    context.fillStyle = "#514";
    context.fillText("MacOS", bx5 - bs / 2, by5 - bs / 2, r5);
    context.fillStyle = "#405";
    context.fillText("Keynote", bx6 - bs / 2, by6 - bs / 2, r6);
    context.fillStyle = "#316";
    context.fillText("Word", bx7 - bs / 2, by7 - bs / 2, r7);
    context.fillStyle = "#227";
    context.fillText("Unity", bx8 - bs / 2, by8 - bs / 2, r8);
    context.fillStyle = "#138";
    context.fillText("MySQL", bx9 - bs / 2, by9 - bs / 2, r9);
    context.fillStyle = "#049";
    context.fillText("DSA", bx10 - bs / 2, by10 - bs / 2, r10);
    context.fillStyle = "#158";
    context.fillText("ML", bx11 - bs / 2, by11 - bs / 2, r11);
    ...
    context.fillText("Jupyter Notebook", bx14 - bs / 2, by14 - bs / 2, r14);
    context.fillStyle = "#594";
    context.fillText("Visual Studio", bx15 - bs / 2, by15 - bs / 2, r15);
    context.fillStyle = "#683";
    context.fillText("CSS", bx16 - bs / 2, by16 - bs / 2, r16);
    context.fillStyle = "#792";
    context.fillText("Latex*", bx17 - bs / 2, by17 - bs / 2, r17);
    context.fillStyle = "#881";
    context.fillText("C#", bx18 - bs / 2, by18 - bs / 2, r18);
    context.fillStyle = "#970";
    context.fillText("Dart", bx19 - bs / 2, by19 - bs / 2, r19);
    context.fillStyle = "#861";
    context.fillText("ReactJs", bx20 - bs / 2, by20 - bs / 2, r20);
